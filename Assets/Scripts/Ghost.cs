...
public class Ghost : MonoBehaviour
{
    ...
    Vector2 GetPinkGhostTargetTile()
    {
        ...
        // 4 pontos à frente do Pac-Man
        // Levando em consideração a orientação e posição
        Vector2 pacManPosition = pacMan.transform.localPosition;
    ...
    Vector2 GetBlueGhostTargetTile()
    {
        ...
        // Seleciona a posição 2 pontos a frente do Pac-Man
        // Desenha o Vector do Blinky para essa posição
        // Dobra o comprimento do Vector
        Vector2 pacManPosition = pacMan.transform.localPosition;
        Vector2 pacManOrientation = pacMan.GetComponent<PacMan>().orientation;
    ...
    Vector2 GetOrangeGhostTargetTile()
    {
        ...
        // Calcula a distância do Pac-Man
        // Se a distância for maior que 8 blocos, a segmentação por blocos é a mesma que Blinky
        // Se a distância for menor que 8 blocos, o destino será seu ponto inicial, assim como o modo de dispersão.
            ...
            if (currentNode.validDirections[i] != direction * -1)
            {
                ...
                if (currentMode != Mode.Consumed)
                {
                    ...
                    if (tile.transform.GetComponent<Tile>().isGhostHouseEntrance == true)
                    {
                        ...
                        // Bloco fantasma encontrado, não permite movimentação
